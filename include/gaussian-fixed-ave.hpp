...
double gaussian_fixed_ave_all64(double _a64, double _b64, float _a32, float _b32) {
  double x = _a64;
  double dev = _b64;
...
double gaussian_fixed_ave_all32(double _a64, double _b64, float _a32, float _b32) {
  float x = _a32;
  float dev = _b32;
