...
template<typename T>
T mb_dist_input_a(void) {
  return (T)rand_double(0.0, 20.0);
}

template<typename T>
T mb_dist_input_b(void) {
  return (T)rand_double(1.0, 5.0);
}
...
double mb_dist_all_64(double _a64, double _b64) {
  ALL64_FPT_0 x   = _a64;
  ALL64_FPT_0 a   = _b64;
...
float mb_dist_mix_0(double _a64, double _b64) {
  MIX0_FPT_0 x   = _a64;
  MIX0_FPT_0 a   = _b64;
...
#define FPT_9  float
#define FPT_10 float
float mb_dist_mix_1(double _a64, double _b64) {
  FPT_0 x   = _a64;
  FPT_0 a   = _b64;
...
#define FPT_9  float
#define FPT_10 float
float mb_dist_all_32(float _a32, float _b32) {
  FPT_0 x   = _a32;
  FPT_0 a   = _b32;
