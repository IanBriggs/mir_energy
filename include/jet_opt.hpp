...
template<typename T>
T jet_opt_input_a(void) {
  return (T)rand_double(-5.0, 5.0);
}

template<typename T>
T jet_opt_input_b(void) {
  return (T)rand_double(-20.0, 5.0);
}
...
double jet_opt_all_64(double _a64, double _b64) {
...
double jet_opt_mix_0(double _a64, float _b32) {
...
float jet_opt_mix_1(float _a32, double _b64) {
...
float jet_opt_all_32(float _a32, float _b32) {
