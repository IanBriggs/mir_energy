...
binary_function_object BINARY_FUNCTIONS[NUM_BINARY_FUNCTIONS] = {
  ...
  {(1L<<29), cone_sa_all_64,  "cone_sa_all_64",       cone_sa_input_a, cone_sa_input_b},
  ...
  {(1L<<29), cone_sa_all_32,  "cone_sa_all_32",       cone_sa_input_a, cone_sa_input_b},

  {(1L<<29), jet_all_64,  "jet_all_64",       jet_input_a, jet_input_b},
  ...
  {(1L<<29), jet_all_32,  "jet_all_32",       jet_input_a, jet_input_b},

  {(1L<<29), jet_opt_all_64,  "jet_opt_all_64",       jet_opt_input_a, jet_opt_input_b},
  ...
  {(1L<<29), jet_opt_all_32,  "jet_opt_all_32",       jet_opt_input_a, jet_opt_input_b},
