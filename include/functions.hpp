...
unary_function_object UNARY_FUNCTIONS[NUM_UNARY_FUNCTIONS] = {
  {(1L<<29), sine_all_64, "sine_all_64",     sine_input_a},
  ...
  {(1L<<29), sine_all_32, "sine_all_32",     sine_input_a},
};


const int NUM_BINARY_FUNCTIONS = 4 + 4 + 5 + 4 + 7 + 7 + 7;
binary_function_object BINARY_FUNCTIONS[NUM_BINARY_FUNCTIONS] = {
  {(1L<<26), MB_dist_all_64,  "MB_dist_all_64",       MB_dist_input_a, MB_dist_input_b},
  ...
  {(1L<<26), MB_dist_all_32,  "MB_dist_all_32",       MB_dist_input_a, MB_dist_input_b},

  {(1L<<30), cone_sa_all_64,  "cone_sa_all_64",       cone_sa_input_a, cone_sa_input_b},
  {(1L<<30), cone_sa_mix_0,  "cone_sa_mix_5E-05",   cone_sa_input_a, cone_sa_input_b},
  {(1L<<30), cone_sa_mix_1,  "cone_sa_mix_1E-04",   cone_sa_input_a, cone_sa_input_b},
  {(1L<<30), cone_sa_all_32,  "cone_sa_all_32",       cone_sa_input_a, cone_sa_input_b},

  {(1L<<28), jet_all_64,  "jet_all_64",       jet_input_a, jet_input_b},
  {(1L<<28), jet_mix_0,  "jet_mix_5E-03",   jet_input_a, jet_input_b},
  {(1L<<28), jet_mix_1,  "jet_mix_7.5E-03", jet_input_a, jet_input_b},
  {(1L<<28), jet_mix_2,  "jet_mix_1E-02",   jet_input_a, jet_input_b},
  {(1L<<28), jet_all_32,  "jet_all_32",       jet_input_a, jet_input_b},

  {(1L<<28), jet_opt_all_64,  "jet_opt_all_64",       jet_opt_input_a, jet_opt_input_b},
  {(1L<<28), jet_opt_mix_0,  "jet_opt_mix_5E-03",   jet_opt_input_a, jet_opt_input_b},
  {(1L<<28), jet_opt_mix_1,  "jet_opt_mix_1E-02",   jet_opt_input_a, jet_opt_input_b},
  {(1L<<28), jet_opt_all_32,  "jet_opt_all_32",       jet_opt_input_a, jet_opt_input_b},

  {(1<<26), gaussian_fixed_x_all_64,    "gaussian_fixed_x_all_64",     gaussian_fixed_x_input_a, gaussian_fixed_x_input_b},
  ...
  {(1<<26), gaussian_fixed_x_all_32,    "gaussian_fixed_x_all_32",     gaussian_fixed_x_input_a, gaussian_fixed_x_input_b},
  {(1<<26), gaussian_fixed_x_adaptive, "gaussian_fixed_x_adaptive",  gaussian_fixed_x_input_a, gaussian_fixed_x_input_b},

  {(1<<26), gaussian_fixed_ave_all_64,    "gaussian_fixed_ave_all_64",     gaussian_fixed_ave_input_a, gaussian_fixed_ave_input_b},
  ...
  {(1<<26), gaussian_fixed_ave_all_32,    "gaussian_fixed_ave_all_32",     gaussian_fixed_ave_input_a, gaussian_fixed_ave_input_b},
  {(1<<26), gaussian_fixed_ave_adaptive, "gaussian_fixed_ave_adaptive",  gaussian_fixed_ave_input_a, gaussian_fixed_ave_input_b},

  {(1<<26), gaussian_fixed_dev_all_64,    "gaussian_fixed_dev_all_64",     gaussian_fixed_dev_input_a, gaussian_fixed_dev_input_b},
  ...
  {(1<<26), gaussian_fixed_dev_all_32,    "gaussian_fixed_dev_all_32",     gaussian_fixed_dev_input_a, gaussian_fixed_dev_input_b},
...
trinary_function_object TRINARY_FUNCTIONS[NUM_TRINARY_FUNCTIONS] = {
  {(1<<26), gaussian_allvars_all_64,    "gaussian_allvars_all_64",     gaussian_allvars_input_a, gaussian_allvars_input_b, gaussian_allvars_input_c},
  ...
  {(1<<26), gaussian_allvars_all_32,    "gaussian_allvars_all_32",     gaussian_allvars_input_a, gaussian_allvars_input_b, gaussian_allvars_input_c},
