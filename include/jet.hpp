...
// all_64
double jet_all_64(double _a64, double _b64) {
  double x1 = _a64;
  double x2 = _b64;
...
// mix_5E-03
double jet_mix_0(double _a64, float _b32) {
  double x1 = _a64;
  float x2 = _b32;
...
// mix_7.5E-03
double jet_mix_1(double _a64, double _b64) {
  double x1 = _a64;
  double x2 = _b64;
...
// mix_1E-02
float jet_mix_2(float _a32, double _b64) {
  float x1 = _a32;
  double x2 = _b64;
...
// all_32
float jet_all_32(float _a32, float _b32) {
  float x1 = _a32;
  float x2 = _b32;
