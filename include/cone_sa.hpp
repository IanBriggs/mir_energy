...
template<typename T>
T cone_sa_input_a(void) {
  return (T)rand_double(1.0, 10.0);
}


template<typename T>
T cone_sa_input_b(void) {
  return (T)rand_double(1.0, 10.0);
}
...
double cone_sa_all_64(double _a64, double _b64) {
...
double cone_sa_mix_0(double _a64, double _b64) {
...
double cone_sa_mix_1(double _a64, float _b32) {
...
float cone_sa_all_32(float _a32, float _b32) {
